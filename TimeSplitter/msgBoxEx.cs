...
namespace TimeSplitter
{
    ...
    public class msgBoxExt
    {
        ...
        private static void startMsgBoxThread()
        {
            ...
            DialogResult result = MessageBox.Show(new Form { TopMost = true }, _currentOptions.text, _currentOptions.caption, _currentOptions.buttons, _currentOptions.icon, _currentOptions.defaultButton);
